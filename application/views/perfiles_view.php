...
<li></li>
  ...
  <div class="content">
     <?php echo $table;
    // echo form_button('crearperfil', 'Clear Perfil', 'onclick="'.base_url().'index.php/perfiles/add"');
     ?>

      <button onClick="window.location.href = '<?php echo base_url();?>index.php/perfiles/add';return false;">Clear Perfil</button>
