...
<li></li>
  ...
  <div class="content">
      ...
      <p>
          ...
          <br /><input id="descripcion" type="text" name="descripcion"  value="<?php echo set_value('descripcion'); ?>"  />
      </p>


      <p>
          <?php echo form_submit( 'submit', 'Crear Perfil'); ?>
